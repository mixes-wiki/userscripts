...
// @require      https://raw.githubusercontent.com/mixes-wiki/userscripts/refs/heads/main/includes/global.js?v-TrackId.net_24
...
// @resource     IMPORTED_CSS https://raw.githubusercontent.com/mixes-wiki/userscripts/refs/heads/main/TrackId.net/script.css?v-4
...
function searchOnMixesWiki(text, target, size) {
    ...
    if (text !== "") {
        ...
        var textOut = trackidNet_FixTitle(text),
            ...
            searchLink = '<a id="' + idName + '" class="' + className + '" href="' + url + '" title="' + linkTitle + '" target="_blank"><img width="' + size + '" src="' + mwLogoUrl + '" alt="' + linkTitle + '"/></a>';
